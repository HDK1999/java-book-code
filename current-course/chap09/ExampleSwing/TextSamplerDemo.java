...
public class TextSamplerDemo extends JFrame implements ActionListener {
	...
	public TextSamplerDemo() {
		...
		textArea.setText("This is an editable JTextArea "
	...
	private JEditorPane createEditorPane() {
		...
		try {
			s = "file:" + System.getProperty("user.dir")
					...
					+ "ExampleSwing/TextSamplerDemoHelp.html";
	...
	private JTextPane createTextPane() {
		...
		String[] initString = { "This is an editable JTextPane, ", "another ",
				"styled ", "text ", "component, ",
				"which supports embedded icons..." + newline, " " + newline,
				"...and embedded components..." + newline,
				" " + newline + newline,
		...
		String[] initStyles = { "regular", "italic", "bold", "small", "large",
				"regular", "icon", "regular", "button", "regular", "regular",
				"regular" };
	...
	protected void initStylesForTextPane(JTextPane textPane) {
		...
		StyleConstants.setIcon(s, new ImageIcon("ExampleSwing/images/Pig.gif"));

		s = textPane.addStyle("button", regular);
		StyleConstants.setAlignment(s, StyleConstants.ALIGN_CENTER);
		JButton button = new JButton(new ImageIcon(
				"ExampleSwing/images/sound.gif"));
