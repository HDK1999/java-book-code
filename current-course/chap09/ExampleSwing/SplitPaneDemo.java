...
public class SplitPaneDemo implements ListSelectionListener {
	...
	public SplitPaneDemo() {
		...
		try {
			imageResource = ResourceBundle.getBundle("ExampleSwing/imagenames");
		...
		ImageIcon firstImage = new ImageIcon("ExampleSwing/images/"
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		if (theList.isSelectionEmpty()) {
			...
			ImageIcon newImage = new ImageIcon("ExampleSwing/images/"
