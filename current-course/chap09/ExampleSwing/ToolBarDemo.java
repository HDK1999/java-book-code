...
public class ToolBarDemo extends JFrame {
	...
	protected void addButtons(JToolBar toolBar) {
		...
		// first button
		button = new JButton(new ImageIcon("ExampleSwing/images/left.gif"));
		...
		// second button
		button = new JButton(new ImageIcon("ExampleSwing/images/middle.gif"));
		...
		// third button
		button = new JButton(new ImageIcon("ExampleSwing/images/right.gif"));
